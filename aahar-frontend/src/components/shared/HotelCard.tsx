...
export function HotelCard({ hotel, className }: HotelCardProps) {
  ...
  return (
    <Link 
      ...
      className={`group flex flex-col relative overflow-hidden rounded-[2rem] sm:rounded-[3rem] bg-white border border-aahar-border transition-all duration-500 hover:shadow-2xl hover:shadow-aahar-dark/5 hover:-translate-y-2 w-full ${className || ""}`}
    >
      {/* Top Image Section */}
