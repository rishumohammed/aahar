...
export default function Error({
 ...
 <h3 className="text-xl font-bold text-aahar-dark uppercase tracking-tight">Tables Loading Glitch</h3>
 <p className="text-sm text-aahar-body max-w-sm mt-2 mb-6">
 We encountered a problem fetching your restaurant dining tables configuration.
 </p>
