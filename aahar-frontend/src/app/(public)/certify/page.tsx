        ...
        <div className="container mx-auto max-w-7xl px-6 sm:px-8 text-center relative z-10">
          <div className="max-w-3xl mx-auto flex flex-col items-center">
            ...
            <div className="mt-8 sm:mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <Button asChild variant="outline" className="bg-white hover:bg-aahar-wash text-aahar-dark border border-aahar-border rounded-xl h-14 px-8 font-black uppercase tracking-wider text-xs shadow-sm transition-all hover:border-aahar-dark">
            ...
            <div className="relative z-10 p-8 sm:p-12 md:p-16 lg:p-20 text-white">
              <div className="max-w-2xl space-y-6">
                ...
                <div className="pt-4 flex flex-col sm:flex-row items-stretch sm:items-center gap-4">
                  ...
                  <Button asChild variant="outline" className="bg-white/10 hover:bg-white/20 text-white backdrop-blur-md border border-white/20 rounded-xl h-14 px-8 font-black uppercase tracking-wider text-xs transition-all hover:border-white/40">
