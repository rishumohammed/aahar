...
"p-3 rounded-full shrink-0",
 ...
 disabled={isReadOnly}
 className="rounded-md border-slate-200 font-semibold text-xs px-5 h-10 gap-2 hover:bg-admin-light hover:text-admin-text"
 >
 ...
 disabled={isReadOnly}
 className="rounded-md bg-admin-primary hover:bg-admin-primary-hover text-white font-semibold text-xs px-6 h-10 gap-2 shadow-sm transition-all"
 >
