...
export default function Error({
 ...
 <h3 className="text-2xl font-black text-aahar-dark tracking-tight">Application Load Failed</h3>
 <p className="text-sm text-aahar-body max-w-md mt-2 mb-8 font-medium">
 We encountered a problem loading your hotel compliance application. Please ensure you are connected and try again.
 </p>
